...
static constexpr auto qt_meta_stringdata_ZN15CharacterWidgetE = QtMocHelpers::stringData(
    "CharacterWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15CharacterWidgetE[] = {
...
Q_CONSTINIT const QMetaObject CharacterWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15CharacterWidgetE.offsetsAndSizes,
    qt_meta_data_ZN15CharacterWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15CharacterWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *CharacterWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15CharacterWidgetE.stringdata0))
