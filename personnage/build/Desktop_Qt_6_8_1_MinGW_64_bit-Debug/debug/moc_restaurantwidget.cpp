...
static constexpr auto qt_meta_stringdata_ZN16RestaurantWidgetE = QtMocHelpers::stringData(
    "RestaurantWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16RestaurantWidgetE[] = {
...
Q_CONSTINIT const QMetaObject RestaurantWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16RestaurantWidgetE.offsetsAndSizes,
    qt_meta_data_ZN16RestaurantWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16RestaurantWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<RestaurantWidget, std::true_type>
    >,
    nullptr
} };
...
void *RestaurantWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16RestaurantWidgetE.stringdata0))
